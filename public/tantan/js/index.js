...
var clickEvent = function(){
	...
	$('.btn-biubiu ').on({
		touchstart:function(){
			...
			if(animation.state == 'Squeeze'){
				return;
			}
			animation.processSqueeze()
		},
		touchend:function(){
			if(this.state == 'PopUp'){
				return
...
var imageLoading = function(){
	var imgArr = [
		'tantan/img/banner@3x.png',
		'tantan/img/main_bg.png',
		'tantan/img/BG.png',
		'tantan/img/chuhuo_err_hongbao_1.png',
		'tantan/img/chuhuo_err_tuikuan_1.png',
		'tantan/img/chuhuo_ing_1.png',
		'tantan/img/chuhuo_suc_1.png',
		'tantan/img/map_1.png',
		'tantan/img/map_2.png',
		'tantan/img/map_3.png',
		'tantan/img/map_4.png',
		'tantan/img/winner_bg_1.png',
		'tantan/img/biubiu_toast.png',
		'tantan/img/xieyi_bg_max.png',
		'tantan/img/xieyi_bg_min.png',
		'tantan/img/gonglve.png',
		'tantan/img/icon_selct_1.png',
		'tantan/img/icon_selct_2.png',
		'tantan/img/icon_selct_3.png',
		'tantan/img/icon_selct_4.png',
	]
